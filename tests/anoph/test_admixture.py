...
Integration test (``test_admixture_*``)
    ...
    ``tests/anoph/conftest.py``.  Run this file from the repository root
    with ``poetry run pytest tests/anoph/test_admixture.py``.

Running the unit tests only
---------------------------
From the repository root::

    poetry run pytest tests/anoph/test_admixture.py -v -k "nmf"
"""
...
from malariagen_data.anoph.admixture import (
    AnophelesAdmixtureAnalysis,
    novel_run_admixture_nmf,
)
